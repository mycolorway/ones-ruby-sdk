...
class OrgApiTest < Minitest::Test
  def test_app_credential_api
    ...
    stub_request(:get, %r[appcenter/org/org_uuid/app_credential]).to_return(status: 200, body: response_body.to_json)
  ...
  def test_constraint_by_user_api
    ...
    stub_request(:get, %r[appcenter/org/org_uuid/constraint/by_user/user_uuid]).to_return(status: 200, body: response_body.to_json)
  ...
  def test_license_api
    ...
    stub_request(:get, %r[appcenter/org/org_uuid/license]).to_return(status: 200, body: response_body.to_json)
  ...
  def test_grant_uuids_api
    ...
    stub_request(:get, %r[appcenter/org/org_uuid/license/grant]).to_return(status: 200, body: response_body.to_json)
